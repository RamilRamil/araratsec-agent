...
from audit_agent.session import AuditInput, AuditSession, Principal, Stage1Report
from audit_agent.finding import Finding
from sr_agent.models.memory import MemoryRecord, SourceType
from audit_agent.planner.sig import build_sig, build_sig_from_smartgraphical
from audit_agent.planner.stage1 import run_stage1
from audit_agent.planner.stage2 import run_stage2
...
def _run_static_analysis(
    ...
    from audit_agent.tools.static_analysis import run_slither, slither_to_findings
...
def _run_smartgraphical_analysis(
    ...
    from audit_agent.tools.smartgraphical import run_smartgraphical, sg_to_findings
...
def start_audit(
    ...
    if stage2_provider in ("local", "auto"):
        ...
        from audit_agent.planner.stage2 import run_stage2_local
