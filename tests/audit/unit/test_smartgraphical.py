...
from audit_agent.finding import BastetTag, Severity
from audit_agent.tools.smartgraphical import (
    SGFinding,
    SmartGraphicalError,
    parse_sg_findings,
    sg_to_findings,
...
_FIXTURES = Path(__file__).resolve().parents[2] / "fixtures" / "smartgraphical"
